"""
hcli/agents/supervisor.py
─────────────────────────
SupervisorAgent — the orchestration brain of hcli.sec.
...
from hcli.utils.ui import agent_panel, status_dashboard
...
class SupervisorAgent(BaseAgent):
    ...
    async def _handle_fetch_cve(self, keyword: str) -> None:
        ...
        from hcli.utils.cve_fetcher import fetch_latest_cve
